var Plugins = function () {
    ...
    var k = function () {
        if ($.fn.sparkline) {
            $.extend(true, $.fn.sparkline.defaults, {
                ...
                tristate: {posBarColor: App.getLayoutColorCode("green"), negBarColor: App.getLayoutColorCode("red")},
                box: {medianColor: App.getLayoutColorCode("red")}
            });
        ...
        if ($.fn.dataTable) {
            ...
            $(".datatable").each(function () {
                ...
                if (w.hasClass("table-checkable")) {
                    $.extend(true, y, {aoColumnDefs: [{bSortable: false, aTargets: [0]}]})
                }
                ...
                if (w.hasClass("table-colvis")) {
                    $.extend(true, y, {
                        ...
                        oColVis: {buttonText: "Columns <i class='icon-angle-down'></i>", iOverlayFade: 0}
                    })
                }
    ...
    var j = {
        ...
        legend: {show: true, labelBoxBorderColor: "", backgroundOpacity: 0.95},
        series: {
            points: {show: false, radius: 3, lineWidth: 2, fill: true, fillColor: "#ffffff", symbol: "circle"},
            lines: {show: true, lineWidth: 2, fill: false, fillColor: {colors: [{opacity: 0.4}, {opacity: 0.1}]},},
            bars: {
                lineWidth: 1,
                barWidth: 1,
                fill: true,
            ...
            pie: {
                show: false, radius: 1, label: {
                    show: false, radius: 2 / 3, formatter: function (o, p) {
        ...
        selection: {color: App.getLayoutColorCode("blue")}
    };
    var b = {
        colors: ["#ffffff"],
        legend: {show: false, backgroundOpacity: 0},
        series: {points: {}},
        grid: {tickColor: "rgba(255, 255, 255, 0.1)", color: "#ffffff",},
        shadowSize: 1
    };
    var f = function () {
        if ($.fn.knob) {
