...
<head>
    ...
    <%--<link rel="stylesheet" type="text/css" href="plugins/bootstrap-tree-view/css/bootstrap-treeview.css">--%>
    ...
    <%--<script type="text/javascript" src="plugins/jQuery-Select2-4.0.1/js/select2.min.js">--%>
    <%--</script>--%>
    ...
    <%--<script type="text/javascript" src="plugins/bootstrap-tree-view/bootstrap-treeview.js">--%>
    <%--</script>--%>
