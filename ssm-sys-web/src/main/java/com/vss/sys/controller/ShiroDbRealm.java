...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0) {
        ...
        info.addStringPermissions(user.getPermissList());
        return info;
    }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        // 把token转换成User对象
        UserDTO userLogin = tokenToUser((UsernamePasswordToken) authcToken);
        // 验证用户是否可以登录
        UserDTO login = userService.login(userLogin);
        UserDTO ui = login;
        if(ui == null)
...
//      Object principal = ui.getUsername();
        ...
        return new SimpleAuthenticationInfo(ui, userLogin.getPassword(), realmName);
    }

    private UserDTO tokenToUser(UsernamePasswordToken authcToken) {
